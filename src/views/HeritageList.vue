  ...
  <div class="heritage-list">
    <div class="page-header">
      <div class="header-content">
        ...
        <el-button type="primary" @click="$router.push('/heritage/upload')">
    ...
    <div class="heritage-content">
      <div class="filter-bar">
        <el-input
          ...
          @input="handleSearch"
        />
        <el-select v-model="filterLevel" placeholder="保护级别" @change="handleFilter">
...
onMounted(() => {
  heritageStore.fetchHeritageList()
})
</script>
