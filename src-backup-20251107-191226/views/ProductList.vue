    ...
    <div class="page-header">
      <div class="header-content">
        ...
        <el-button 
          type="primary" 
          aria-label="上传商品"
          @click="$router.push('/product/upload')"
        >
        ...
        >
          <div class="product-image" @click="viewProductDetail(product.id)">
            < img 
              ...
              :alt="product.name"
            />
            <div v-else-if="product.image" class="image-container">
...
const filteredProducts = computed(() => {
  let filtered = Array.isArray(productStore.productList) ? productStore.productList : []
